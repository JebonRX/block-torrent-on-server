...
wget -q -O/etc/trackers https://raw.githubusercontent.com/JebonRX/block-torrent-on-server/main/domains
...
curl -s -LO https://raw.githubusercontent.com/JebonRX/block-torrent-on-server/main/Thosts
